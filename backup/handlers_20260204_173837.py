...
@router.callback_query(F.data == "main_menu", F.state == "*")
...
@router.callback_query(F.data == "catalog", F.state == "*")
...
@router.callback_query(F.data.startswith("category:"), F.state == "*")
...
@router.callback_query(F.data.startswith("back_to_products:"), F.state == "*")
